<script lang="ts">
	...
	const repoUrl = 'https://shuuen.app/r/your-library';
...
<div class="flex min-h-screen flex-col bg-background text-foreground">
	...
	<main class="mx-auto w-full max-w-[720px] flex-1 px-6 pb-28">
		<!-- Hero -->
		<section id="top" class="flex flex-col items-center pt-24 pb-20 text-center">
			<span
				class="mb-8 text-[10px] font-semibold uppercase tracking-[0.25em] text-muted-foreground/70"
			>
				終焉 · The End / Final Moment
			</span>
			<img src="/images/shuuen-logo.png" alt="Shuuen" class="mb-9 w-full max-w-[360px]" />
			<h1 class="max-w-[460px] text-3xl font-semibold leading-tight text-balance">
				The last ear trainer app you need.
			</h1>
			<p class="mt-5 max-w-[480px] text-sm leading-relaxed text-muted-foreground text-pretty">
				A next-generation ear-training app for musicians. Identify singles, transcribe melodies,
				drill chords and progressions — across Windows, Linux and Android. Build your own levels,
		...
		<section id="repository" class="pt-2 pb-3">
			<div class="mb-5 flex flex-col gap-1.5">
				<span class="text-xs font-semibold uppercase tracking-[0.2em]">Link This Site To The App</span>
				<span class="text-xs leading-relaxed text-muted-foreground">
					Copy your repository URL and paste it into Shuuen to sync levels and library. No login
					required.
				</span>
			</div>
			<div class="flex items-center gap-2 rounded-xl bg-card py-2 pr-2 pl-4 ring-1 ring-foreground/10">
				<Link2 class="size-5 shrink-0 text-muted-foreground" />
				<code class="min-w-0 flex-1 truncate font-mono text-sm text-foreground">{repoUrl}</code>
		...
		<section id="download">
			<div class="mb-7 flex flex-col gap-1.5">
				<span class="text-xs font-semibold uppercase tracking-[0.2em]">Download</span>
				<span class="text-xs leading-relaxed text-muted-foreground">
			...
			<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
				<Card.Root>
					<Card.Header class="flex flex-col items-start gap-4">
						<div class="flex size-13 items-center justify-center rounded-full bg-muted">
							<Monitor class="size-6 text-foreground" />
						</div>
						<div class="flex flex-col gap-1">
							<Card.Title class="text-base">PC</Card.Title>
							<Card.Description class="text-[11px] font-medium uppercase tracking-[0.15em]">
								Windows · Linux
							</Card.Description>
						</div>
					</Card.Header>
	...
	<footer class="border-t border-border px-6 py-7">
		<div class="mx-auto flex max-w-[720px] flex-wrap items-center justify-between gap-4">
			<span class="text-[10px] font-medium uppercase tracking-[0.2em] text-muted-foreground/70">
				終焉 · Shuuen
			</span>
